...
class GameSimulatorGUI:
    ...
    def update_field(self):
        ...
        # self.canvas.delete("card_level1")
        # self.canvas.delete("card_level2")
        # self.canvas.create_text(510, 510, text=f"카드 레벨 : {card_level1}", font=("Arial", 14, "bold"), fill="white", tags="card_level1")
        # self.canvas.create_text(730, 510, text=f"카드 레벨 : {card_level2}", font=("Arial", 14, "bold"), fill="white", tags="card_level2")
        ...
        # 클리어률
        # self.canvas.create_text(1100, 680, text=f"클리어률 : 50%", font=("Arial", 14, "bold"), fill="yellow", tags="reroll")
    ...
    def simulate_play_mode_action(self, simulator, return_data):
        ...
        # print("-----------디버그-------------")
        # print(self.data[0]['make_position'][0]['Position'] if self.data[0]['make_position'] else None)
        # print([idx + 1 for idx, key in enumerate(self.data[0]['select_card']) if self.data[0]['select_card'][key] == 1])
        # print([self.data[0]['use_reroll'][0]['Roll']] if self.data[0]['use_reroll'][0]['Used'] else [])
    ...
    def update_selection_display(self):
        ...
        # self.canvas.create_text(
        #     1100, 50,
        #     text=f"Selected Position: {make_position}",
        #     font=("Arial", 12),
        #     fill="white",
        #     tags="selection_display"
        # )
        #
        # self.canvas.create_text(
        #     1100, 80,
        #     text=f"Selected Card: {select_card_text}",
        #     font=("Arial", 12),
        #     fill="white",
        #     tags="selection_display"
        # )
